      ...
      <div className={`background ${show ? "invisible" : ""}`}>
        <div className="landing">
          ...
          <div className="aboutUS">
            ...
            <p className="plant_logo_left"><img src="https://tse3.mm.bing.net/th/id/OIP.zeVmOtPEJDM9IFCN9DkeXQHaHk?rs=1&pid=ImgDetMain&o=7&rm=3" height='50px' width='50px' alt="" /></p>
            <p className="aboutUs-content">
            ...
            <p className="plant_logo_right"><img src="https://tse3.mm.bing.net/th/id/OIP.zeVmOtPEJDM9IFCN9DkeXQHaHk?rs=1&pid=ImgDetMain&o=7&rm=3" height='50px' width='50px' alt="" /></p>
